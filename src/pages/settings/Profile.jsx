...
// import EditProfileModal from '../../components/SettingsComponent/EditprofileModal'; // To be created
...
const Profile = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-lg shadow p-8 mt-8">
      ...
      {/* {editOpen && <EditProfileModal open={editOpen} onClose={() => setEditOpen(false)} user={user} />} */}
    </div>
  );
}
