...
const EditoldUnit = ({ open, setOpen, unitData, onSuccess }) => {
  ...
  useEffect(() => {
    if (unitData) {
      ...
      setFormData({
        ...rest,
        stock_type: "old_product", // Always set to old_product
      });
    }
  }, [unitData]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white rounded-lg shadow-lg p-6 min-w-[420px] max-w-full">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold">Edit Old Product Unit</h2>
          <button
